...
! function(a) {
    ...
    var c = function() {
        ...
        return a.prototype.addKeyUpListener = function(a) {
            ...
            if (void 0 !== a)
                if (this.type === b.text || this.type === b.password) this.element.maxLength = parseInt(a, 10);
                else if (this.type === b.number) {
    ...
    var c = function(c) {
        ...
        return __extends(d, c), Object.defineProperty(d.prototype, "width", {
            ...
            if (this.inputOptions.type === a.InputType.password)
                for (var c = 0; c < this.value.length; c++) b += "*";
            ...
            if (this.text.setText(b), this.text.width > this.inputOptions.width) this.text.anchor.x = 1, this.text.x = this.inputOptions.padding + this.inputOptions.width;
            ...
            if (this.inputOptions.type === a.InputType.password) {
                c = "";
                for (var d = 0; d < this.value.length; d++) c += "*"
            }
...
! function(a) {
    var b = function(a) {
        function b(b, c) {
            ...
            d.bgColor = c.backgroundColor ? parseInt(c.backgroundColor.slice(1), 16) : 16777215, d.borderRadius = c.borderRadius || 0, d.borderWidth = c.borderWidth || 1, d.borderColor = c.borderColor ? parseInt(c.borderColor.slice(1), 16) : 9803157, d.boxAlpha = c.fillAlpha, d.padding = c.padding;
            var e, e = c.height,
                f = c.width;
